 ...
 */
typedef void (*app_byte_set_cb_t)(const app_byte_server_t * p_server, uint16_t byte);
 ...
 */
typedef void (*app_byte_get_cb_t)(const app_byte_server_t * p_server, uint16_t * p_present_byte);
